...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-effects-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-effects-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-effects-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-effects-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-effects-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-effects-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-effects` can be installed with:

```
conda install r-effects
```

It is possible to list all of the versions of `r-effects` available on your platform with:
